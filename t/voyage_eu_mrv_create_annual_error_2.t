# $Id: voyage_eu_mrv_create_annual_error_2.t 35732 2019-01-18 06:02:06Z p0660 $
...
subtest "No.11 no round" => sub {
  ...
  # 戻り値データ出力
  $res->set_save_path("$test_out_dir/7_out.json");
  $res->save;

  # 四捨五入されていないことの確認
  is($res->{data}->{data}->{eu_to_eu}->{data}->{distance_travelled},'2.5','round is nothing');
