# $Id: voyage_eu_mrv_data_summarizer_error_2.t 35732 2019-01-18 06:02:06Z p0660 $
...
# test
subtest "No.19 not exist EU_country" => sub {

  # EU_country.jsonをリネームして実行
  my $res = VoyageEuMrvDataSummarizer::_calc_voyage_type('voyage','TAR','HLS');
  is($res,'no_eu','Case No.13 is ok');
